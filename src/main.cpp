...
#if defined(NDEBUG)
# error "Beecoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x77338c5c27aaa774899bc5bd17b741842b7136495ddd56d9f04458a039957059");
...
{
    // Beecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Beecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Beecoin: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // Beecoin: 30 seconds
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Beecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x77338c5c27aaa774899bc5bd17b741842b7136495ddd56d9f04458a039957059");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The BeeCoin is a new Bitcoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x740888a26b8f937c7fc676671bab27e28980d835e6b3e35b72a7ef3fc6e9f055"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Beecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BeecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BeecoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static BeecoinMiner(CWallet *pwallet)
{
    printf("BeecoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running BeecoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BeecoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BeecoinMiner, pwallet));
}
